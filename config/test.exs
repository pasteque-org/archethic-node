...
alias MockCrypto.NodeKeystore.Origin
...
config :archethic, Archethic.Bootstrap.NetworkInit,
  genesis_pools: [
    %{
      address:
        Base.decode16!("000073bdaf847037115914ff5ca15e52d162db57b5089d5e4bf2005d825592c9c945",
          case: :mixed
        ),
...
config :archethic, Archethic.Crypto.NodeKeystore.Origin, Origin
...
config :archethic, MemoryLedger, enabled: false
config :archethic, MemoryLedger, size_threshold: 2000
...
config :archethic, Origin, enabled: false

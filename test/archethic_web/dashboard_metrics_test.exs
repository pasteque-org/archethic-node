defmodule ArchethicWeb.DashboardMetricsTest do
  ...
  test "buckets are cleaned automatically" do
    ...
    # 5 because the clean_state function will automatically create the `now` bucket
    assert 5 = length(Map.keys(buckets))
  end
end
